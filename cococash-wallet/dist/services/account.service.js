...
exports.getBalance = exports.createAccount = void 0;
const uuid_1 = require("uuid");
const accountRepository = __importStar(require("../repositories/account.repository"));
const AppError_1 = require("../errors/AppError");
const createAccount = async (userId, initialBalance) => {
    if (initialBalance < 0) {
        throw new AppError_1.AppError("Initial balance cannot be negative", 400);
    }
    const account = {
        id: (0, uuid_1.v4)(),
        userId,
